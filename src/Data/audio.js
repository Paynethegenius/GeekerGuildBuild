...
export const soundObject = {
  jingles: [
    { sound: soundA, name: "Nitro 121 Theme Song", Id: 1 },
    { sound: soundB, name: "Arla Dano, Go for it English", Id: 2 },
    { sound: soundC, name: "Arla Dano, Go for it, Igbo", Id: 3 },
    { sound: soundD, name: "Close Up Demo", Id: 4 },
    { sound: soundE, name: "GOtv Showtime Signature tune", Id: 5 },
  ],
